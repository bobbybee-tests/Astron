...
bool unpack_db_fields(DatagramIterator &dg, const bamboo::Class* dclass,
                      std::unordered_map<const bamboo::Field*, std::vector<uint8_t> > &required,
                      std::map<const bamboo::Field*, std::vector<uint8_t> > &ram);
